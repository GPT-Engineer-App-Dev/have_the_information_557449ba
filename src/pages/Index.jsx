...
const Index = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTrackingNumber(uniqueNumber);
    const addressLabel = `Cyklop CSC Att.: SampleLab M.Slot ${uniqueNumber}\nWilhelm Röntgenstraat 10\n8013NC\nZwolle\nNederland`;
    toast({
      title: "Form submitted.",
      description: `We've received your sample request. Your tracking number is ${uniqueNumber}. Please print and use the following label for shipping:\n${addressLabel}`,
      status: "success",
      duration: 9000,
      isClosable: true,
    });
    ...
    <Container maxW="container.md" py={10}>
      ...
      <Box as="form" onSubmit={handleSubmit} border="1px" borderColor="gray.200" p={6} borderRadius="md" boxShadow="sm">
        <VStack spacing={4}>
          ...
          {trackingNumber && (
            <Button onClick={() => window.print()} colorScheme="green" mt={4}>
